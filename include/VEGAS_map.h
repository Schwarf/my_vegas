...
public:
    ...
    void accumulate_weights(double evaluated_integrand); // evaluated_integrand is the integrand, no other manipulation
    double get_jacobian();
    void update_map();
    double checking_map();
...
private:
    double alpha_{0.5}; // The parameter control the smooth of weight
